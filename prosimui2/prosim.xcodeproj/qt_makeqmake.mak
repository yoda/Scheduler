...
QMAKE    = /usr/bin/qmake
prosim.xcodeproj/project.pbxproj: prosim.pro  /usr/local/Qt4.5/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.5/mkspecs/common/unix.conf \
	...
	$(QMAKE) -macx -o prosim.xcodeproj/project.pbxproj prosim.pro
